...
|---| ----- | ---------- | ---------- | ------ |
|1662|[检查两个字符串数组是否相等](https://leetcode.com/problems/check-if-two-string-arrays-are-equivalent/) | [golang](go/q1528.go)|Easy| ✔ |
|1528|[重新排列字符串](https://leetcode.com/problems/shuffle-string/) | [golang](go/q1528.go)|Easy| ✔ |
|1480|[一维数组的动态和](https://leetcode-cn.com/problems/running-sum-of-1d-array/) | [golang](go/q1480.go)|Easy| ✔ |
